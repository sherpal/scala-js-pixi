...
case object Video extends PIXIExample {

  val name: String = "Video"

  val pixiUrl: String = "https://pixijs.io/examples/#/basics/video.js"
  ...
  override def newApplication(): Application = {
    ...
    def onPlayVideo() {
      ...
      val texture = Texture.fromVideo("required/assets/testVideo.mp4")
