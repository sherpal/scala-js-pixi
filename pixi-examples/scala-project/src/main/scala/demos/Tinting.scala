...
import pixigraphics.{Application, Rectangle, Sprite}

object Tinting extends PIXIExample {

  val name: String = "Tinting"

  val pixiUrl: String = "https://pixijs.io/examples/#/demos/tinting.js"
  ...
  def newApplication(): Application = {
    ...
    final class Dude {
      ...
      val dude: Sprite =  Sprite.fromImage("required/assets/eggHead.png")
